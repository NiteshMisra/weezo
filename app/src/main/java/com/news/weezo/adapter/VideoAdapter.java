...
public class VideoAdapter extends RecyclerView.Adapter<VideoAdapter.NotificationViewHolder> {
    ...
    public VideoAdapter(Context context, int layoutView, ArrayList<MediaFile> list, OnRecycleItemClick recycleItemClick) {
...
//    }
    ...
    public void onBindViewHolder(final NotificationViewHolder holder, int position) {
        ...
        if (model.getDescription() != null) {
            holder.tv_title.setText(Html.fromHtml(model.getDescription()).toString().trim());
        }
